...
type
  TForm1 = class(TForm)
    ...
    procedure existeNum1Click(Sender: TObject);
  private
...
procedure TForm1.existeNum1Click(Sender: TObject);
var sw : boolean;
begin
 sw := m.existe(StrToInt(Edit3.Text));
 ShowMessage(BoolToStr(sw, true));
